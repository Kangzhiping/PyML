...
retT = []
for ishare in df_sh:
    newfac = getData(ishare, '2010-11-27', '2017-11-27', 261)
    newret = getDataR(ishare, '2010-11-27', '2017-11-27', 261)
    # fac.append(newfac)
    ...
    newfacT = getData(ishare, '2016-08-01', '2017-11-27', 31)
    newretT = getDataR(ishare, '2016-08-01', '2017-11-27', 31)
    # fac.append(newfac)
