...
pos_file = 'ch2_data/pos.txt'
neg_file = 'ch2_data/neg.txt'
...
def neural_network(data):
    ...
    layer_output_w_b = {'w_': tf.Variable(tf.random_normal([n_layer_4, n_output_layer])),
    ...
    layer_output = tf.add(tf.matmul(layer_4, layer_output_w_b['w_']), layer_output_w_b['b_'])
